...
git clone https://$gitea2/sbwml/luci-app-dockerman -b nft feeds/luci/applications/luci-app-dockerman
rm -rf feeds/packages/utils/{docker,dockerd,containerd,runc}
git clone https://$gitea2/sbwml/packages_utils_docker feeds/packages/utils/docker
git clone https://$gitea2/sbwml/packages_utils_dockerd feeds/packages/utils/dockerd
git clone https://$gitea2/sbwml/packages_utils_containerd feeds/packages/utils/containerd
git clone https://$gitea2/sbwml/packages_utils_runc feeds/packages/utils/runc
...
git clone https://$gitea2/sbwml/miniupnpd feeds/packages/net/miniupnpd -b v2.3.9
git clone https://$gitea2/sbwml/luci-app-upnp feeds/luci/applications/luci-app-upnp -b openwrt-24.10
